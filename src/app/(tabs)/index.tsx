...
// ── Cuisine theme map (decorative banners for photo-less cards) ────────────────
  ...
  return (
    ...
    >
      ...
      <View style={styles.smallCardBody}>
        ...
        {recipe.cuisine ? (
          <Text style={[styles.smallCardCuisine, { color: photoUri ? c.textMuted : bg }]} numberOfLines={1}>
            {recipe.cuisine}
          </Text>
        ) : null}
      </View>
...
// ── Section header (serif title + green action) ───────────────────────────────
function SectionHeader({
  ...
  return (
    <View style={{
      ...
      <Text style={{ fontSize: 20, fontFamily: Fonts.serif, color: c.textPrimary, letterSpacing: -0.2 }}>
        {label}
      </Text>
      {action ? (
        <Pressable onPress={onAction} hitSlop={8}>
          <Text style={{ fontSize: FontSize.sm, color: c.primary, fontFamily: Fonts.bodyBold }}>{action}</Text>
        </Pressable>
      ) : null}
    </View>
  );
            ...
            >
              ...
              <View style={styles.featuredBody}>
                ...
                <View style={styles.featuredMeta}>
                  {cookTonight.cuisine ? (
                    <View style={[styles.metaCuisineChip, { backgroundColor: colors.primary + '18' }]}>
                      <Text style={[styles.metaCuisineText, { color: colors.primary }]}>
                        {cookTonight.cuisine}
                      </Text>
                    </View>
                  ) : null}
...
const makeStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  greetingLine: { fontSize: 27, fontFamily: Fonts.serif, color: c.textPrimary, lineHeight: 34, letterSpacing: -0.3 },
  greetingEmoji: { fontSize: 22 },
  greetingSubtitle: { fontSize: FontSize.xs, color: c.textMuted, marginTop: 3, fontFamily: Fonts.body },
  themeToggle: {
  ...
  lovePillText: { fontSize: 12, color: c.primaryDark, fontFamily: Fonts.bodySemibold },
  ...
  searchPlaceholder: { fontSize: FontSize.sm, color: c.textMuted, fontFamily: Fonts.body },
  ...
  featuredBanner: { height: 200, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  featuredBannerScrim: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.30)' },
  todaysBadge: {
    position: 'absolute', top: 12, left: 14,
    backgroundColor: 'rgba(15,15,16,0.55)',
    borderRadius: BorderRadius.full, paddingHorizontal: 10, paddingVertical: 4,
  },
  todaysBadgeText: { fontSize: 10, fontFamily: Fonts.bodyExtrabold, color: '#fff', letterSpacing: 0.8 },
  diffBadge: {
    position: 'absolute', top: 12, right: 14,
    backgroundColor: 'rgba(255,255,255,0.25)',
    borderRadius: BorderRadius.full, paddingHorizontal: 10, paddingVertical: 4,
  },
  diffBadgeText: { fontSize: 11, fontFamily: Fonts.bodyBold, color: '#fff' },
  featuredEmojiRing: {
  ...
  featuredTitle: { fontSize: 21, fontFamily: Fonts.serif, color: c.textPrimary, lineHeight: 27, marginBottom: 8, letterSpacing: -0.2 },
  featuredMeta: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 16, flexWrap: 'wrap' },
  metaCuisineChip: { borderRadius: BorderRadius.full, paddingHorizontal: 9, paddingVertical: 3 },
  metaCuisineText: { fontSize: 12, fontFamily: Fonts.bodyBold },
  metaDot: { fontSize: 14, color: c.textMuted },
  metaInfo: { fontSize: 13, color: c.textSecondary, fontFamily: Fonts.body },
  metaStar: { fontSize: 13, color: c.warning, fontFamily: Fonts.bodySemibold },
  cookBtn: { borderRadius: 14, paddingVertical: 15, alignItems: 'center' },
  cookBtnText: { color: '#fff', fontSize: FontSize.md, fontFamily: Fonts.bodyBold, letterSpacing: 0.2 },

  smallCard: { width: 150, backgroundColor: c.surface, borderRadius: 16, marginRight: 10, overflow: 'hidden', ...Shadow.sm },
  ...
  smallCardRatingText: { fontSize: 10, color: '#fff', fontFamily: Fonts.bodyBold },
  smallCardBody: { padding: 10 },
  smallCardTitle: { fontSize: 13, fontFamily: Fonts.bodySemibold, color: c.textPrimary, lineHeight: 17, marginBottom: 3 },
  smallCardCuisine: { fontSize: 11, fontFamily: Fonts.bodyBold },

  discoverSubtitle: { fontSize: FontSize.xs, color: c.textMuted, paddingHorizontal: Spacing.md, marginBottom: 10, fontFamily: Fonts.body },
  discoverSkeleton: { width: 150, height: 170, borderRadius: 14, backgroundColor: c.surfaceAlt, marginRight: 10 },
  discoverErrorBox: {
    marginHorizontal: Spacing.md, backgroundColor: c.surface, borderRadius: 14, padding: Spacing.lg,
    alignItems: 'center', borderWidth: 1, borderColor: c.border, gap: 8,
  },
  discoverErrorIcon: { fontSize: 28 },
  discoverErrorText: { fontSize: FontSize.sm, color: c.textSecondary, textAlign: 'center', lineHeight: 20, fontFamily: Fonts.body },

  emptyCard: {
    marginHorizontal: Spacing.md, marginBottom: Spacing.lg, backgroundColor: c.surface,
    borderRadius: 20, padding: Spacing.lg, alignItems: 'center', ...Shadow.sm,
  },
  emptyEmoji: { fontSize: 48, marginBottom: 12 },
  emptyTitle: { fontSize: 20, fontFamily: Fonts.serif, color: c.textPrimary, marginBottom: 6 },
  emptyDesc: { fontSize: FontSize.sm, color: c.textSecondary, textAlign: 'center', lineHeight: 20, marginBottom: 16, fontFamily: Fonts.body },
  emptyCta: { backgroundColor: c.primary, borderRadius: 14, paddingHorizontal: Spacing.lg, paddingVertical: 12 },
  emptyCtaText: { color: '#fff', fontFamily: Fonts.bodyBold, fontSize: FontSize.sm },
  ...
  handle: { width: 38, height: 4, backgroundColor: c.border, borderRadius: 2, alignSelf: 'center', marginTop: 10, marginBottom: 2 },
  previewThumb: { width: '100%', height: 190 },
  previewBody: { padding: Spacing.md },
  previewTitle: { fontSize: FontSize.xl, fontFamily: Fonts.serif, color: c.textPrimary, marginBottom: Spacing.sm },
  previewChips: { flexDirection: 'row', gap: 6, marginBottom: Spacing.sm },
  chip: {
    backgroundColor: c.surfaceAlt, borderRadius: BorderRadius.full,
    paddingHorizontal: 10, paddingVertical: 4,
  },
  chipText: { fontSize: FontSize.xs, color: c.textSecondary, fontFamily: Fonts.bodyMedium },
  previewIngLabel: { fontSize: FontSize.sm, fontFamily: Fonts.bodyBold, color: c.textPrimary, marginBottom: 4 },
  previewIngList: { fontSize: FontSize.sm, color: c.textSecondary, lineHeight: 20, marginBottom: Spacing.md, fontFamily: Fonts.body },
  saveBtn: { backgroundColor: c.primary, borderRadius: 14, paddingVertical: 14, alignItems: 'center' },
  saveBtnText: { color: '#fff', fontSize: FontSize.md, fontFamily: Fonts.bodyBold },
});
